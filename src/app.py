...
def main():
    ...
    with col2:
        st.markdown('<h1>Transcreva Vídeos do <span style="color: #69C9D0; border-bottom: 5px solid #69C9D0; border-radius: 0 0 0 8px;">Tik</span><span style="color: #EE1D52; border-bottom: 5px solid #EE1D52; border-radius: 0 0 8px 0;">Tok</span></h1>', unsafe_allow_html=True)
    with col1:
    ...
    with st.form("link_form"):
        ...
        if submitted:
            ...
            <script>
                ...
                lastButton.classList.add('custom-button');
            </script>
            """, unsafe_allow_html=True)
            if not link:
